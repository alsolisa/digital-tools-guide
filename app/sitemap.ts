...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const updated = new Date("2026-07-13T00:00:00+08:00");
  const routes = ["", "/nodes", "/subscriptions", "/ai", "/apps", "/downloads", "/methodology", "/search", "/faq", "/privacy", "/disclosure", "/changelog"];
  return [

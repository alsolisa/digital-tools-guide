...
export default function DownloadsPage() {
  ...
  return (
    <PageShell>
      <PageIntro eyebrow="下载中心 · 先选设备" title="下载只认官方入口" lead="这里整理 AI、常用应用和网络客户端：闭源应用只指向官网或应用商店；开源客户端直接给出当前官方文件，并标出版本、大小和文件指纹。" artwork={{ src: "/illustrations/official-downloads-v4.webp", alt: "唯一官方母档沿保管轨道经过两条孔位完全一致的完整性检查带，再分配到四种尺寸不同的本地文件包", caption: "先确认来源，再选择与你设备对应的版本" }} />

...
export default function MethodologyPage() {
  ...
  return (
    <PageShell>
      <PageIntro eyebrow="公开方法 · 让结论可以被检查" title="先看证据，再看推荐" lead="这页说明本站怎样核验信息：推广链接可能带来收益，但不能改变事实；关键内容都会注明来源、核验时间、风险状态和自动更新规则。" aside={<><strong>最近公开入口同步</strong><p>{checkedAt}</p><small>{syncStatus.links.length}个入口 · {syncStatus.clients.length}个开源项目</small></>} />

...
export default function MethodologyPage() {
  ...
  return (
    <PageShell>
      ...
      <section className="content-section disclosure-page"><SectionHeading index="05" title="推广、隐私与边界" /><ul><li>GamsGo及部分机场按钮包含推广关系，按钮附近明确写明。</li><li>推广收益不会改变排序、风险标签或核验结论。</li><li>本站不销售服务，不代收付款，不保存账号、密码、验证码、订阅链接或访问密钥。</li><li>人民币金额只是汇率参考，不含税费和支付手续费。</li><li>网络与应用可用性应遵守用户所在地法律、平台条款和组织规定。</li></ul></section>
    </PageShell>
  );
}

...
export default function DisclosurePage() {
  return <PageShell><PageIntro eyebrow="推广说明 · 推荐与收益分开" title="有推广关系，也必须把风险说清楚" lead="部分机场和 GamsGo 按钮带有推广返利：你通过它购买，本站可能获得收益。合作关系只决定哪些服务提供推广入口，不改变价格核验、风险等级或排序；本站收录的也不是全市场完整名单。" />

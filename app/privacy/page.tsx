...
export const metadata = { title: "隐私说明", description: "数字工具指南的数据收集边界、第三方链接、自动核验和用户安全说明。" };
...
export default function PrivacyPage() {
  return <PageShell><PageIntro eyebrow="隐私说明 · 最少收集" title="你不需要把账号交给这个网站" lead="数字工具指南是公开资料与教程网站，不提供登录、付款或代操作功能。使用本站不需要提交个人账号、密码、验证码、订阅链接或付款信息。" />
    ...
    <section className="content-section soft-section"><SectionHeading index="02" title="浏览器中的本地功能" /><div className="two-column-cards"><article><span>LOCAL</span><h3>站内搜索</h3><p>搜索词只在当前页面内用于筛选内容，不发送到本站服务器。</p></article><article><span>LINK</span><h3>外部链接</h3><p>点击官网、应用商店、GitHub或推广链接后，将适用对应第三方的隐私政策与条款。</p></article></div></section>

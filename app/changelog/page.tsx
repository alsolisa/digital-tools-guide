...
const updates = [
  { date: "2026-08-09", title: "全站时效、安全与可用性复核", items: ["订阅价格增加14天人工数据有效期：自动读取冲突、失败或待二次确认时，一律隐藏旧价格与套餐按钮。", "机场方案把当前月付、过期月付记录和过期非月付记录分开；Clash Verge本地镜像落后官方版本时自动暂停。", "更新ChatGPT动态Instant命名、Claude Fable 5与Opus 5、Perplexity高级模型列表及Midjourney V8.2，并补充对应官方来源。", "恢复机场问题排查；按最新要求移除AI订阅付款前计算与检查整段，并修复站内搜索指向。", "站点地图改用各页面实际更新时间，补充PWA图标并修正多处小字号文字对比度。"] },

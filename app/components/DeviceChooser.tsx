...
const devices: Record<DeviceKey, { label: string; system: string; file: string; network: string; warning: string }> = {
  "windows-x64": { label: "Windows普通电脑", system: "Windows x64", file: "优先选择名称含 x64、x86_64 或 amd64 的正式版本", network: "新手优先 Clash Verge Rev；需要更多协议时再考虑 v2rayN", warning: "不要选择源码包、ARM版或名称不明的压缩包。" },
  ...
  android: { label: "Android手机/平板", system: "Android", file: "多数近年设备选择 arm64-v8a；不确定时优先从Google Play安装", network: "FlClash或Hiddify相对直观；只从项目发布页或官方商店下载", warning: "不要安装群文件、网盘APK或所谓去限制修改版。" },

...
export default function AppsIndexPage() {
  return (
    <PageShell>
      <PageIntro eyebrow="常用海外应用 · 从用途开始" title="先知道它是做什么的，再决定要不要安装" lead="YouTube 偏长视频和学习，X 偏实时公开信息，TikTok 偏短视频和创作。收录只代表这里有完整说明，不等于每个人都需要安装。" artwork={{ src: "/illustrations/media-apps-v4.webp", alt: "三条纸艺时间轨分别用稀疏长段、密集不规则脉冲和六个短小竖幅表现三种内容节奏", caption: "观看、讨论与发现，是三种不同的内容节奏" }} />

...
const baseSubscriptionOffers: SubscriptionOffer[] = [
  ...
  },
  {
    ...
    deliveryType: "多种方式", risk: "high", riskLabel: "", ownership: "可能是独立账号交付，不一定是本人原账号", privacy: "交付账号应立即检查恢复邮箱、二次验证和密码修改权限", renewal: "确认到期后账号能否继续使用", support: "联系客服处理 · 7×24小时", payment: "Visa、Mastercard、Apple Pay、Google Pay 等；以GamsGo结算页为准", region: "Claude本身有支持地区限制",
    sourceUrl: "https://www.gamsgo.com/details/claude", affiliateUrl: "https://www.gamsgo.com/details/claude/partner/BTzCM", verifiedAt: checkedAt,
  },
  {
    ...
    deliveryType: "独立账号交付", risk: "high", riskLabel: "", ownership: "通常交付新的Google账号资料", privacy: "不建议把私人Gmail、照片或云盘资料迁入来源不明的交付账号", renewal: "确认云存储和订阅到期后的数据处理", support: "联系客服处理 · 7×24小时", payment: "Visa、Mastercard、Apple Pay、Google Pay 等；以GamsGo结算页为准", region: "权益和存储容量随地区与产品变化",
    sourceUrl: "https://www.gamsgo.com/details/gemini", affiliateUrl: "https://www.gamsgo.com/details/gemini/partner/BTzCM", verifiedAt: checkedAt,
  },
  {
    ...
    deliveryType: "多种方式", risk: "medium", riskLabel: "", ownership: "可能是独立账号交付，不一定是本人原账号", privacy: "不要把X账号密码交给不明页面", renewal: "确认SuperGrok与X Premium不是同一订阅", support: "联系客服处理 · 7×24小时", payment: "Visa、Mastercard、Apple Pay、Google Pay 等；以GamsGo结算页为准", region: "Grok与商店可用性随地区变化",
    sourceUrl: "https://www.gamsgo.com/details/grok", affiliateUrl: "https://www.gamsgo.com/details/grok/partner/BTzCM", verifiedAt: checkedAt,
  },
  {
    ...
    deliveryType: "独立账号交付", risk: "high", riskLabel: "", ownership: "账号通常由平台提供，不等同于本人原账号", privacy: "不要在交付账号中保存敏感研究、公司文件或个人资料", renewal: "确认到期后历史记录能否导出", support: "联系客服处理 · 7×24小时", payment: "Visa、Mastercard、Apple Pay、Google Pay 等；以GamsGo结算页为准", region: "模型和用量随地区、套餐变化",
    sourceUrl: "https://www.gamsgo.com/details/Perplexity_AI", affiliateUrl: "https://www.gamsgo.com/details/Perplexity_AI/partner/BTzCM", verifiedAt: checkedAt,
  },
  {

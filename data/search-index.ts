...
const coreEntries: SearchEntry[] = [
  ...
  { title: "GamsGo与AI订阅", href: "/subscriptions#offers", category: "AI订阅", description: "GamsGo是什么、为什么有人选择第三方、官方购买和账号交付有什么区别。", keywords: ["GamsGo", "官方购买", "第三方", "充值", "共享", "账号", "价格", "付款", "退款"] },
  { title: "官方下载与开源备用文件中心", href: "/downloads", category: "下载", description: "按Windows、macOS、Android、iOS和网页端查找官方入口；官方页面打不开时，可下载三项已公开版本与SHA-256的开源客户端备用文件。", keywords: ["下载", "本地下载", "备用下载", "安装包", "SHA-256", "Windows", "Mac", "Android", "iPhone", "App Store", "Google Play", "Clash", "FlClash", "Hiddify", "Shadowrocket"] },
  { title: "主流AI模型评测解读", href: "/benchmarks", category: "AI评测", description: "分开解读Arena真人盲测和Artificial Analysis能力、速度、延迟与API成本。", keywords: ["Arena", "Artificial Analysis", "模型排名", "Claude", "GPT", "Gemini", "Grok", "DeepSeek", "Qwen", "GLM", "Kimi"] },

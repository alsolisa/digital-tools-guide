...
const items = [
  ...
  { slug: "midjourney", name: "Midjourney", company: "Midjourney, Inc.", domain: "midjourney.com", issue: "AI TUTORIAL / 06", accent: "#69558f", title: "图片与视频创作指南", subtitle: "官方网页 · 提示词 · 风格参考 · 编辑与隐私", chapters: ["官方入口", "套餐与用量", "第一次生成", "编辑与整理", "公开范围与授权"] },

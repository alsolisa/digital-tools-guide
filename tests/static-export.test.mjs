...
test("脚本、样式、图片资源均使用正确子目录", async () => {
  ...
  assert.match(home, /https:\/\/alsolisa\.github\.io\/digital-tools-guide\/og-evidence-ledger-v17\.jpg/);
  assert.match(home, /<meta property="og:image:width" content="1200"\/>/);
  assert.match(home, /<meta property="og:image:height" content="630"\/>/);
  assert.equal(await exists(path.join(root, "og-evidence-ledger-v17.jpg")), true, "V17社交分享图没有进入静态发布包");
